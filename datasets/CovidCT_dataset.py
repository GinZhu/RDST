...
class CovidCTReader(MedicalImageBasicDataset):
    """
...
class CovidCTMultiSRTrain(CovidCTReader, BasicMultiSRTrain):
    """
    Behaviours:
    ...
    def __init__(self, paras):
        super(CovidCTMultiSRTrain, self).__init__()
...
class CovidCTMultiSRTest(CovidCTReader, BasicMultiSRTest):

    def __init__(self, paras, patient_ids,):
        super(CovidCTMultiSRTest, self).__init__()
    ...
    def get_test_pair(self, item):
        ...
        :return:
            ...
            'real_sr_scale': float
        """
        sample = super(CovidCTMultiSRTest, self).get_test_pair(item)
        for s in sample:
            if self.lr_image_size_remain:
